...
public class MqttDecodePubRel: NSObject {
    ...
    public func decodePubRel(fixedHeader: UInt8, pubAckData: [UInt8]) {
        ...
        decodePubRel(fixedHeader: fixedHeader, pubAckData: pubAckData, protocolVersion: protocolVersion)
    }

    func decodePubRel(fixedHeader: UInt8, pubAckData: [UInt8], protocolVersion: CocoaMQTTProtocolVersion) {
